      ...
      <div class="therichpost-row-padding therichpost-margin-bottom">
        <form class="form-width" method="POST" action="/customers">
            ...
            <div class="form-group">
              ...
              <input hidden type="text" class="form-control" placeholder="Enter Customer Comment" name="konzola" value="/">
              <input hidden type="text" class="form-control" placeholder="Enter Customer Comment" name="reservations" value="/">
            </div>
